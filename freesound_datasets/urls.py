...
urlpatterns = [
    ...
    url(r'^registration_form/(?P<backend>[^\/]+)/$', registration_form, name='registration-form'),
    url(r'^terms_acceptance_form/', terms_acceptance_form, name='terms-acceptance-form'),
