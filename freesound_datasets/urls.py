...
#    url(r'^(?P<short_name>[^\/]+)/explore/(?P<node_id>[^\/]+)/$', taxonomy_node_page, name='dataset-explore-taxonomy-node'),
#    url(r'^(?P<short_name>[^\/]+)/explore/(?P<node_id>[^\/]+)/ajax$', taxonomy_node2, name='taxonomy-node'),
